    ...
    <div class=" ">
        <nav class="hidden lg:flex justify-between items-center px-10 sticky top-0 z-50 bg-white shadow-md">
            <div class="pl-10 py-3 flex items-center gap-3 max-w-[400px]">
                ...
                <div class="text-2xl font-bold leading-5 text-[#316275] font-serif">JCOR MEDICAL EQUIPMENT INC.</div>
            </div>
    ...
    <div class="bg-black  text-white flex flex-col items-center justify-center space-y-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-10 px-10">
            <div>
                ...
                <p class="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur perferendis exercitationem qui, dolor 
                    animi veniam, placeat neque saepe itaque architecto quis nisi omnis eum tenetur cum recusandae rerum sapiente. Veniam.</p>
            </div>
            <div class="space-y-2">
                ...
                <div class="flex">
                    ...
                    <p class="text-xs text-balance">099999999898</p>
                </div>
                <div class="flex">
                    <x-icon class="w-10" name="envelope" solid color="red"/>
                    <p class="text-xs text-balance">sampol@sampol.com</p>
                </div>
            </div>
